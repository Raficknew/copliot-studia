...
**Format:** Folder `.agents/` lub zawarty w konfiguracji

```yaml
# .agents/mailer-refactoring-agent.yaml
...
model: claude-4-5-sonnet  # lub dostępny model
